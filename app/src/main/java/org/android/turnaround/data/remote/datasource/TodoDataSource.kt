...
class TodoDataSource @Inject constructor(
    ...
    suspend fun getTodoList(): BaseResponse<TodoListResponse> = todoService.getTodoList()
    suspend fun getTodoDetail(todoId: Int): BaseResponse<TodoDetailResponse> = todoService.getTodoDetail(todoId)
    suspend fun deleteTodo(todoId: Int): BaseResponse<String> = todoService.deleteTodo(todoId)
    suspend fun putTodo(todoId: Int, body: TodoEditRequest): BaseResponse<String> = todoService.putTodo(todoId, body)
